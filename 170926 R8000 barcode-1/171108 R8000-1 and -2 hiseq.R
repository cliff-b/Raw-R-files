...
g.sumOs <- ggplot(filter(sumR100RD, grepl("O",X_peptide)), aes(X_peptide, Y_peptide)) + geom_tile(aes(fill=mean_RD)) + facet_grid(X_group~condition, labeller = labeller(condition=induction_labels), scales = "free") +
